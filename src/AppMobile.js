            ...
            <div className="content-container" style={containerStyle}>
                ...
                <div className="mobile-container">
                    ...
                    <div className="bio1 item fade-in">
                        Ik ben Jorit Doeswijk, orthopedagoog gespecialiseerd in autisme en sensorische
                        informatieverwerking. Vanuit de overtuiging dat ieder mens uniek is, bied ik ondersteuning op
                        maat – met kennis, betrokkenheid en oog voor ieders eigenheid.
                    </div>
                    <div className="img item fade-in">
                        <img src={photo1} alt="headshot"/>
                    </div>
                    ...
                    <div className="bio1 item fade-in">
                        ...
                        Om persoonlijk tot rust te komen stap ik graag op de fiets om lange tochten te maken.
                        <br></br><br></br>
                        ...
                        beperking, moeilijk verstaanbaar gedrag en epilepsie. De mensen die daar wonen hebben naast een
                        verstandelijke beperking ook vaak de diagnose Autisme Spectrum Stoornis.
                    </div>
                    <div className="img item fade-in">
                    ...
                    <div className="bio1 item fade-in">
                        ...
                        Oegstgeest. Ook heb ik gewerkt voor het jeugd en gezinsteam Leiden namens stichting MEE Zuid
                        Holland Noord en ben ik begeleider geweest bij Ons Tweede Thuis.
                        <br></br><br></br>
                        Tijdens mijn werk als begeleider bij de diverse instellingen heb ik mij altijd zeer
                        geïnteresseerd in de vraag waar gedrag vandaan komt, waar ik dagelijks mee te maken kreeg. Ik
                        vind het belangrijk dat ik kan zorgen dat iemand zo fijn mogelijk de dag doorkomt. Vanuit deze
                        gedachten heb ik besloten om na mijn studie Social Work aan de Hogeschool INHolland (Haarlem)
                        door te studeren als Orthopedagoog aan de VU in Amsterdam. Na deze studie ben ik als
                        Orthopedagoog verbonden aan meerdere woningen voor mensen met een verstandelijke beperking.
                        Daarin ondersteun ik de mensen met een verstandelijke beperking en het netwerk eromheen en de
                        begeleiders.
                    </div>
                    <div className="img item fade-in">
                    ...
                    <div className="bio1 item fade-in">
                        ...
                        Van mensen met een Autisme Spectrum Stoornis is bekend dat zij vaak problemen ervaren in het
                        verwerken van de vele prikkels die zij op een dag ervaren. Om meer kennis te krijgen over hoe
                        zij hiermee om kunnen gaan, heb ik mij gespecialiseerd in Sensorische Informatie Verwerking (SI)
                        en Autisme. Dit heeft mij geholpen om deze problemen beter te begrijpen bij kinderen en
                        volwassenen met Autisme met en zonder een ontwikkelingsachterstand/ verstandelijke beperking.
                        <br></br><br></br>
